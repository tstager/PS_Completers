...
It is a static-first completer for terminal device inspection. The script exposes the command's option catalog and falls back to filesystem path completion for operand slots.

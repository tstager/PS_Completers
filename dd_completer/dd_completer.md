...
It is a static-first completer for the dd block-copy workflow. The script exposes a compact option catalog for common dd flags and falls back to filesystem path completion for operand slots.

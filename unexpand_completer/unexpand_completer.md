...
It is a static-first completer for the unexpand command surface. The script exposes the supported option catalog and falls back to filesystem path completion for operand slots.

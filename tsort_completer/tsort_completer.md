...
It is a static-first completer for topological sort. The script exposes the command's option catalog and falls back to filesystem path completion for operand slots.

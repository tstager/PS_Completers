...
function Remove-ShufOuterQuotes {
    param([string]$Value)
...
function Get-ShufPathCompletions {
    ...
    $cleanInput = Remove-ShufOuterQuotes -Value $InputPath
    ...
    foreach ($item in $items) {
        ...
        $quotedPath = ConvertTo-ShufQuotedValue -Value $pathText -AlwaysQuote $alwaysQuote
...
function Complete-Shuf {
    ...
    $currentWord = if ($cursorPosition -gt $commandAst.Extent.EndOffset) {
        ...
        Get-ShufCurrentToken -Line $commandAst.ToString() -CursorPosition $cursorPosition -Fallback $wordToComplete
    }

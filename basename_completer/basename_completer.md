...
It is a static-first completer for the basename path-splitting workflow. The script exposes a compact option catalog for common basename flags and falls back to filesystem path completion for operand slots.

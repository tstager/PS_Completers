...
It is a help-driven completer with a static fallback for the environment utility workflow. The script exposes the command's option catalog from the installed build, then falls back to filesystem path completion for operand slots.

...
It is a static-first completer for checksum-style file summing. The script exposes the command's option catalog and falls back to filesystem path completion for operand slots.

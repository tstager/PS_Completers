...
function Get-FmtCompletionOptions {
    @('-c', '--crown-margin', '-s', '--split-only', '-t', '--tagged-paragraph', '-u', '--uniform-spacing', '-w', '--width', '-h', '--help', '-V', '--version')
}
...
function Complete-Fmt {
    ...
    $currentWord = if ($cursorPosition -gt $commandAst.Extent.EndOffset) {
        ...
        Get-FmtCurrentToken -Line $commandAst.ToString() -CursorPosition $cursorPosition -Fallback $wordToComplete
    }

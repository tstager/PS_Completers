...
It is a static-first completer for file truncation. The script exposes the command's option catalog and falls back to filesystem path completion for operand slots.
